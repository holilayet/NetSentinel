 ...
 * This file demonstrates how to integrate Netsentinel with a web frontend
 */

// For React/Vue/Angular applications
export class NetsentinelClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NetsentinelClient(provider, contractAddress);
